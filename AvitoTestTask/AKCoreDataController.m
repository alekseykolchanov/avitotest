...
@interface AKCoreDataController ()
...
@implementation AKCoreDataController

+(AKCoreDataController *)share
{
    static dispatch_once_t once;
    static AKCoreDataController *sharedInst;
    dispatch_once(&once, ^{
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"avitotest" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"avitotest.sqlite"];
